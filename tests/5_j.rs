...
fn jump_positive() {
    ...
    //               |    ||                        |
    assert_eq!(bin, "00010100000000000000000000000011");
}
...
fn jump_negative() {
    ...
    //               |    ||                        |
    assert_eq!(bin, "00010100000000000000000000000000");
}
...
fn addressing() {
    ...
    //               |    ||                        |
    assert_eq!(bin, "00010100000000000000000000000110");
}
